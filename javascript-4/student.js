...
let faveColors = ["blue", "purple", "weird mustard"];
...
let me = {
    firstName: "LyAnn",
    superHeroName:"SuperDuperLameCoder-TM",
    homeTown: "PrivateIsland#5",
    superPowers: ["PinaColadaBlast", "TsunamiTacos", "SharknadoDreams"],
