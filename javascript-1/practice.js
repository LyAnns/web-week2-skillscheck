...
me.greeter = () => {return 'Hello! My name is '+me.firstName+' and I live in '+me.state}
...
let total = myNumbers.reduce((a,b)=>{return a+b})
...
let enemies = people.filter(element => {return element.friend == false})
...
let totallyAwesome = people.reduce((total,element)=>{return total+element.awesomeLevel}, 0);
